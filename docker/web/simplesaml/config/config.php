...
$config = [
   ...
   * reverse proxy).
   */
  'baseurlpath' => getenv('SAML_BASE_URL'),
   ...
   * root directory.
   */
  'loggingdir' => '/srv/simplesaml_php/log/',
  //'datadir' => '/var/data/',
   ...
   */
  'technicalcontact_name' => 'Brendan Anderson',
  'technicalcontact_email' => 'brendan_anderson@hcpss.org',
  ...
  */
   ...
   */
  'session.cookie.secure' => getenv('DRUPAL_ENV') !== 'dev',
   ...
   */
  'metadatadir' => '/srv/simplesaml_config/metadata',
   ...
   * syntaxes.
   */
  'store.sql.dsn'                 => 'sqlite:/srv/sqlite/sqlitedatabase.sq3',
